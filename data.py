...
training_set_output = [
    ({'contains(unveiled)': True, 'contains(trains)': True, 'contains(october,)': True, 'contains(hanging)': True, 'contains(bike)': True, 'contains(storage)': True, 'contains(spaces)': True, 'contains(carriage)': True, 'contains(australian)': False, 'contains(banks)': False,
      'contains(ruled)': False, 'contains(financing)': False, 'contains(mine)': False, 'contains(fusion)': False, 'contains(power)': False, 'contains(technological)': False, 'contains(goals)': False, 'contains(pursuit)': False, 'contains(clean)': False, 'contains(energy)': False,
      'contains(arguing)': False, 'contains(switch)': False, 'contains(electric)': False, 'contains(transport)': False, 'contains(drive)': False, 'contains(future)': False, 'contains(demand)': False, 'contains(winter)': False, 'contains(riding)': False, 'contains(rural)': False,
      'contains(modern)': False, 'contains(lights)': False, 'contains(make)': False, 'contains(much)': False, 'contains(easier)': False, 'contains(2015)': False, 'contains(paris)': False, 'contains(recognised)': False, 'contains(contribution)': False, 'contains(indigenous)': False,
      'contains(knowledge)': False, 'contains(climate)': False, 'contains(change)': False, 'contains(facebook)': False, 'contains(helps)': False, 'contains(environment)': False, 'contains(experience)': False, 'contains(employing)': False, 'contains(disabled)': False, 'contains(people)': False,
      'contains(brilliant)': False, 'contains(employees)': False, 'contains(london)': False, 'contains(foreign)': False, 'contains(workers)': False, 'contains(keep)': False, 'contains(growing)': False, 'contains(boosting)': False, 'contains(export)': False, 'contains(progress)': False,
      'contains(deal)': False, 'contains(avoid)': False, 'contains(hard)': False, 'contains(border)': False, 'contains(island)': False, 'contains(ireland)': False, 'contains(discuss)': False, 'contains(house)': False, 'contains(officials)': False, 'contains(necessary)': False,
      'contains(repay)': False, 'contains(previous)': False, 'contains(travel)': False, 'contains(claims)': False, 'contains(coal)': False, 'contains(2025,)': False, 'contains(coal-fired)': False, 'contains(electricity)': False, 'contains(since)': False, 'contains(2012)': False,
      'contains(saving)': False, 'contains(vaquita)': False, 'contains(mexican)': False, 'contains(government,)': False, 'contains(illegal)': False, 'contains(fishing)': False, 'contains(totoaba)': False, 'contains(crops)': False, 'contains(gaining)': False, 'contains(recognition)': False,
      'contains(african)': False, 'contains(farming)': False, 'contains(context)': False, 'contains(using)': False, 'contains(wingtags)': False, 'contains(android)': False, 'contains(ios,)': False, 'contains(turkey)': False, 'contains(fans)': False, 'contains(report)': False,
      'contains(sightings)': False, 'contains(tagged)': False, 'contains(birds,)': False, 'contains(help)': False, 'contains(national)': False, 'contains(forest,)': False, 'contains(everitt)': False, 'contains(promote)': False, 'contains(tree)': False, 'contains(planting)': False,
      'contains(measure)': False, 'contains(heat)': False, 'contains(absorbed)': False, 'contains(oceans,)': False, 'contains(melting)': False, 'contains(ice,)': False, 'contains(level)': False, 'contains(rise)': False, 'contains(accord)': False, 'contains(dealing)': False,
      'contains(winter,)': False, 'contains(sedately)': False, 'contains(office)': False, 'contains(clothes)': False, 'contains(juggling)': False, 'contains(garments)': False, 'contains(christmas)': False, 'contains(party)': False, 'contains(year,)': False, 'contains(feeling)': False,
      'contains(pretty)': False, 'contains(happy)': False, 'contains(eu)': False, 'contains(citizens)': False, 'contains(right)': False, 'contains(stay)': False, 'contains(firefighters)': False, 'contains(spent)': False, 'contains(hour)': False, 'contains(youtube)': False,
      'contains(prankster)': False, 'contains(cemented)': False, 'contains(head)': False, 'contains(microwave)': False, 'contains(oven)': False, 'contains(water)': False, 'contains(river)': False, 'contains(normally)': False, 'contains(generates)': False, 'contains(total)': False,
      'contains(megawatts)': False, 'contains(electricity,)': False, 'contains(supply)': False, 'contains(last)': False, 'contains(years)': False, 'contains(extraordinary)': False, 'contains(time)': False, 'contains(service)': False, 'contains(poland)': False, 'contains(poles)': False,
      'contains(honour,)': False, 'contains(szydło)': False, 'contains(twitter)': False, 'contains(spending)': False, 'contains(watchdog)': False, 'contains(project)': False, 'contains(risky)': False, 'contains(expensive)': False, 'contains(smogs)': False, 'contains(possible)': False,
      'contains(pollution)': False, 'contains(smell)': False, 'contains(north)': False, 'contains(alaska)': False, 'contains(industry)': False, 'contains(suck)': False, 'contains(life)': False, 'contains(biggest)': False, 'contains(uncertainty)': False, 'contains(society)': False,
      'contains(afford)': False, 'contains(ignore)': False, 'contains(brexit)': False, 'contains(makes)': False, 'contains(headlines)': False, 'contains(fail,)': False, 'contains(popularity)': False, 'contains(term)': False, 'contains(populism)': False, 'contains(nativism)': False,
      'contains(radical)': False, 'contains(2016,)': False, 'contains(david)': False, 'contains(camerons)': False, 'contains(austerity)': False, 'contains(agenda)': False, 'contains(child)': False, 'contains(poverty)': False, 'contains(rates)': False, 'contains(britains)': False,
      'contains(exit)': False, 'contains(northern)': False, 'contains(risks)': False, 'contains(policed)': False, 'contains(tories)': False, 'contains(economic)': False, 'contains(strategy)': False, 'contains(failed)': False, 'contains(stated)': False, 'contains(terms)': False,
      'contains(adonis)': False, 'contains(criticised)': False, 'contains(johnson)': False, 'contains(failing)': False, 'contains(speak)': False, 'contains(against)': False, 'contains(high)': False, 'contains(packets)': False, 'contains(health)': False, 'contains(safety)': False,
      'contains(executives)': False, 'contains(myth-busting)': False, 'contains(website)': False, 'contains(rebut)': False, 'contains(nonsense)': False, 'contains(defence)': False, 'contains(secretary)': False, 'contains(daily)': False, 'contains(mail)': False, 'contains(dead)': False,
      'contains(terrorist)': False, 'contains(harm)': False, 'contains(britain)': False, 'contains(meeting)': False, 'contains(scheduled)': False, 'contains(may,)': False, 'contains(attack)': False, 'contains(manchester)': False, 'contains(arena)': False, 'contains(may)': False,
      'contains(americans)': False, 'contains(support)': False, 'contains(plan,)': False, 'contains(republican)': False, 'contains(voters)': False, 'contains(polar)': False, 'contains(bears)': False, 'contains(rely)': False, 'contains(hunt)': False, 'contains(seals)': False,
      'contains(global)': False, 'contains(warming)': False, 'contains(threatens)': False, 'contains(species)': False, 'contains(timber)': False, 'contains(planks)': False, 'contains(logging)': False, 'contains(site)': False, 'contains(discovered)': False, 'contains(palawan)': False,
      'contains(network)': False, 'contains(tourist)': False, 'contains(town)': False, 'contains(nido)': False, 'contains(government)': False, 'contains(defended)': False, 'contains(nuclear)': False, 'contains(face)': False, 'contains(falling)': False, 'contains(renewable)': False,
      'contains(costs)': False, 'contains(fire)': False, 'contains(diego)': False, 'contains(highway)': False, 'contains(strong)': False, 'contains(winds)': False, 'contains(security)': False, 'contains(issues)': False, 'contains(affecting)': False, 'contains(apples)': False,
      'contains(software)': False, 'contains(iphone)': False, 'contains(computers)': False, 'contains(hmrc)': False, 'contains(levy)': False, 'contains(fine)': False, 'contains(sports)': False, 'contains(direct)': False, 'contains(amount)': False, 'contains(double)': False, 'contains(wages)': False,
      'contains(owed)': False, 'contains(hate)': False, 'contains(crimes)': False, 'contains(lgbt)': False, 'contains(russia)': False, 'contains(doubled)': False, 'contains(five)': False, 'contains(years,)': False, 'contains(according)': False, 'contains(research)': False,
      'contains(recently)': False, 'contains(started)': False, 'contains(primary)': False, 'contains(school)': False, 'contains(mother)': False, 'contains(going)': False, 'contains(die)': False, 'contains(paradise)': False, 'contains(panama)': False, 'contains(papers)': False,
      'contains(super-rich)': False, 'contains(powerful)': False, 'contains(trusted)': False, 'contains(regulate)': False, 'contains(themselves)': False, 'contains(corbyn)': False}, 'positive'),
    ({'contains(unveiled)': False, 'contains(trains)': False, 'contains(october,)': False, 'contains(hanging)': False, 'contains(bike)': False, 'contains(storage)': False, 'contains(spaces)': False, 'contains(carriage)': False, 'contains(australian)': True, 'contains(banks)': True,
      'contains(ruled)': True, 'contains(financing)': True, 'contains(mine)': True, 'contains(fusion)': False, 'contains(power)': False, 'contains(technological)': False, 'contains(goals)': False, 'contains(pursuit)': False, 'contains(clean)': False, 'contains(energy)': False,
      'contains(arguing)': False, 'contains(switch)': False, 'contains(electric)': False, 'contains(transport)': False, 'contains(drive)': False, 'contains(future)': False, 'contains(demand)': False, 'contains(winter)': False, 'contains(riding)': False, 'contains(rural)': False,
      'contains(modern)': False, 'contains(lights)': False, 'contains(make)': False, 'contains(much)': False, 'contains(easier)': False, 'contains(2015)': False, 'contains(paris)': False, 'contains(recognised)': False, 'contains(contribution)': False, 'contains(indigenous)': False,
      'contains(knowledge)': False, 'contains(climate)': False, 'contains(change)': False, 'contains(facebook)': False, 'contains(helps)': False, 'contains(environment)': False, 'contains(experience)': False, 'contains(employing)': False, 'contains(disabled)': False, 'contains(people)': False,
      'contains(brilliant)': False, 'contains(employees)': False, 'contains(london)': False, 'contains(foreign)': False, 'contains(workers)': False, 'contains(keep)': False, 'contains(growing)': False, 'contains(boosting)': False, 'contains(export)': False, 'contains(progress)': False,
